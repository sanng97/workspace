...
// DAO ( Data(Database) Access Object) : 데이터 베이스 접근 객체
...
public class MemberDAO {
	...
	// - 외부 변수 값을 SQL에 받아드릴( 삽입할) 준비가 되어 있는 statement
	// -> 성능, 속도면에서 우위르 ㄹ가지고 있음
...
//				+ "   DEFAULT, DEFAULT)"
        ...
        result = pstmt.executeUpdate(); // 매개변수에 sql 추가 x , 이미 pstmt 생성할때 추가했기 때문에
	...
	public int deleteMember(Connection conn, Member member) {
		...
		// 2. SQL 작성
		// ? (Placeholder): preparedStatement에서 사용할 빈칸 ( 값대입예정)
