...
public class Calculator {
	...
	private final int MAX_VALUE = 1000_000_000;
	private final int MIN_VALUE = -1000_000_000;
	...
	public double div (double number) {
		...
		if(number == 0 ) { // 전달받은 값이 0일경우
			saveValue= 0;
			return saveValue;
			
			// number가 0인경우 saveValue를 0으로 만든 후
			// 0 return 후 메서드 종료
			
			
		}
		
		// number가 0이 아닌경우 saveValue를 0으로 만든 후
