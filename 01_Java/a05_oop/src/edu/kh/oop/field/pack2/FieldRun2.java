...
public class FieldRun2 extends FieldTest1 /*상속*/ {
	...
	public static void main(String[] args) {
		...
		//FieldTest1 객체생성 -> 다른 패키지에 있으므로 import 필요
		
		FieldTest1 f1 = new FieldTest1();
		
		System.out.println(f1.v1); //public
//		System.out.println(f1.v2); // protected :같은패키지 + 상속
//		System.out.println(f1.v3); // (default) : 같은패키지
//		System.out.println(f1.v4); // private : 같은 클래스
	...
	public void testMethod() {
		System.out.println(v2); // 다른패키지 이지만 상속(protexted)라서 가능
