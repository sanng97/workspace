...
public class Student {
	...
	{
		// 인스턴스 생성 시
		// 인스턴스 변수 (static 없는 필드)를 초기화하는용도
	...
	//  클래스명.변수명으로 생성되기 때문에 클래스 변수라고 부른다
	
	
	
	
	// static : 같은 타입 객체끼리 공유 목적
	
	// static 메모리 영역 ==  정적 메모리 영역
	// -> 프로그램 실행 시 static 영역에 생성되고
	//    프로그램이 끝나기 전까지 고정 ( 사라지지않음)
	// -> 고정된 static을 프로그램 어디서든 공유가능
	//      (공유 메모리 영역)
	
	
	public static String schoolName = "중구 중학교" ;//학교이름
	
	// 클래스 초기화 블럭
	static {
    //name = "abc";  //인스턴스 변수는 클래스 초기화 블럭에서 초기화 불가능
