...
public class StudentService {
	...
	public StudentService() {
		...
		studentList.add( new Student(2, 7, 12, "김갑순", 'F', 85) );
		studentList.add( new Student(1, 4, 5, "박흥민", 'M', 60) );
		studentList.add( new Student(2, 3, 8, "이미영", 'F', 90) );
		studentList.add( new Student(3, 1, 2, "김샛별", 'F', 100) );
	...
	public List<Student> sortScore() {
		...
		// Collcetions.sort(List) : 원본 List가 정렬
		// -> 이 기능을 사용하려면
