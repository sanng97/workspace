...
// 매개변수 생성자
	...
	public String toString() {
		return "Student [grade=" + grade + ", ban=" + ban + ", number=" + number + ", gender=" + gender + ", score="
				+ score + "]";
	}
	
	// A.equals(B) : A 객체와, B객체가 가지고 있는 필드의 값이 
	...
	if(! ( obj instanceof Student)) { // 비교 대상이 student 가 아니면
		return false;
...
// 중요 equals()를 오버라이딩 했으면
	...
	//hashCode() : 해시 테이블 ( 객체 주소록) 에서 객체를 빨리 찾아가게 하기 위한 번호
