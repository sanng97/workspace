...
//	List list = new ArrayList(); // 10칸 짜리 생성
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (list.get(i) instanceof String) {// i번째 요소가 String
				String s = (String) list.get(i); // 다운캐스팅
	...
	public void ex2() {
		...
		// list.set( int index, E e) : 지정된 index의 요소를 바꿈
		...
		System.out.println(list.contains(" 누룽지 "));
