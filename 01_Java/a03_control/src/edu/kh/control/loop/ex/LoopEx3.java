...
public class LoopEx3 {
	...
	public void ex3() {
		...
		String orderMenu = ""; // 빈 문자열 (빈칸)
								// 합계를 구하는 sum을 초기화 할 때 0을 사용하는 것
								// 처럼 문자열을 이어쓰기 하더라도 아무런 영향이 없는 문자열
		...
		while(input != 9) { // 9 입력 시 조건식이 false가 되어 while문 종료
			...
			case 9 :  System.out.println("주문완료"); break;
    ...
    // do - while 문 : while문의 조건식 위치를 끝으로 보낸 while문	
