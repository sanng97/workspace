...
CREATE TABLE MEMBER(
       -- 컬럼명 자료형
        ...
        ENROLL_DATE DATE DEFAULT SYSDATE  NOT NULL,-- 기본값을 현재 시간으로 지정
        MEMBER_DEL_FL CHAR(1) DEFAULT 'N'  NOT NULL       
);
		ALTER TABLE MEMBER ADD CONSTRAINT MEMBER_PK PRIMARY KEY(MEMBER_NO);
		ALTER TABLE MEMBER ADD CONSTRAINT MEMBER_PK CHECK (MEMBER_DEL_FL IN ('N','Y'));
		
		COMMENT ON COLUMN MEMBER.MEMBER_NO IS "회원번호";
	    COMMENT ON COLUMN MEMBER.MEMBER_EMAIL IS "회원이메일";
		COMMENT ON COLUMN MEMBER.MEMBER_PW IS "회원 비밀번호";
        COMMENT ON COLUMN MEMBER.MEMBER_NICKNAME "회원 닉네임";
 		COMMENT ON COLUMN MEMBER.MEMBER_TEL "휴대폰번호";
		COMMENT ON COLUMN MEMBER.MEMBER_ADDRESS "회원주소";
		COMMENT ON COLUMN MEMBER.ENROLL_DATE "회원가입일";
		COMMENT ON COLUMN MEMBER.MEMBER_DEL_FL "탈퇴여부 (N  :탈퇴 X , Y :탈퇴 O)";
...
--------------------------------------------------------------------------
		...
		READ_COUNT NUMBER DEFAULT NOT NULL,
		BOARD_DEL_FL CHAR(1) DEFAULT 'N' NOT NULL,
		MEMBER_NO NUMBER NOT NULL;
	
		ALTER TABLE BOARD ADD CONSTRAINT MEMBER_NO_PK PRIMARY KEY (BOARD_NO);
		ALTER TABLE BOARD ADD CONSTRAINT BOARD_DEL_FL CHECK (BOARD_DEL_FL IN ('N','Y');
		FOREIGN KEY (MEMBER_NO) REFERENCES MEMBER;
		
	
		COMMENT ON COLUMN BOARD.BOARD_NO IS "게시글 번호";
		COMMENT ON COLUMN BOARD.BOARD_TITLE IS "회원 이메일";
		COMMENT ON COLUMN BOARD.BOARD_CONTENT IS"게시글 내용";
		COMMENT ON COLUMN BOARD.B_CREATE_DATE IS "게시글 작성일";
		COMMENT ON COLUMN BOARD.READ_COUNT IS "조회수";
		COMMENT ON COLUMN BOARD.BOARD_DEL_FL IS "삭제여부 (N : 삭제X , Y :삭제 O)";
...
---------------------------------------------------------------------
    ...
    ALTER TABLE "COMMENT" ADD CONSTRAINT CONNENT_PK PRIMARY KEY(COMMENT_NO);
	ALTER TABLE "COMMENT" ADD CONSTRAINT COMMENT  COMMENT_DEL_CHK CHECK (COMMENT_DEL_FL 'N','Y');
    ...
    COMMENT ON COLUMN "COMMENT".BORAD_NO IS "댓글이 작성된 게시글 번호";
    COMMENT ON COLUMN "COMMNET".MEMBER_NO IS "댓글 작성자 회원 번호";
