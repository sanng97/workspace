...
DEPT_ID CONSTRAINT SYS_C0014138 NULL; -- DEPT_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014139 NULL; 

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014143 NULL; 
 ...
 * 
 * 
 * 2) "COMMINT" ->COMMINT 테이블명 작성 시 ""쌍따옴표감싸기
 * 
 */
...
CREATE TABLE MEMBER(
       -- 컬럼명 자료형
        ...
        ENROLL_DATE DATE DEFAULT SYSDATE NULL,-- 기본값을 현재 시간으로 지정
        MEMBER_DEL_FL CHAR(1) NULL ;
