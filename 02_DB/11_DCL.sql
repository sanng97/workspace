...
--> 오라클 SQL을 예전방식으로 쉽게 작성하도록 하겠다
--> 관리자 계정 접속 할 때 마다 수행

-- 계정생성
CREATE USER a230830_pse IDENTIFIED BY "i5frnzxy";
-->  생성 후 db 접속 방법 추가
--> 접속 권한 없음

/* 접속 권한 부여 (GRANT) */
GRANT CREATE SESSION TO a230830_pse;
...
GRANT CREATE TABLE TO a230830_pse;

ALTER USER a230830_pse DEFAULT TABLESPACE "A230724"
...
INSERT INTO TB_MEMBER VALUES(100,'TEST_PSE','12341234');
COMMIT;
...
-- 다른계정의 TB_MEMBER 테이블 조회
SELECT * FROM A230830_BDH.TB_MEMBER;

SELECT * FROM TB_MEMBER ;

INSERT INTO A230830_BDH.TB_MEMBER tm TB_MEMBER
VALUES(12345, '아이디입니다','비밀번호');
...
SELECT * FROM A230724_BDH.TB_MEMBER;
