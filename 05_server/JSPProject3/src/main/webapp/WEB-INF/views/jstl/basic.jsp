...
<body>
  ...
  <pre>
  - 변수 선언 (속성추가 == setAttribute) 를 위한 태그
  - 작성 가능한 속성
    1. var : 변수명 (== 속성 key)
  ...
  <c:set var="test1" value="테스트1"/> <%-- scope 미지정 == page --%> 
  ...
  <c:set var = "temp" value="<h1>c:out 테스트 중.</h1>"/>
  ...
  EL : EL로 출력 시 escapeXml="false"상태 적용 (html해석함)
