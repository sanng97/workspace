...
public class OpenApiController {
	...
	public String ex2( Model model ,
			@RequestParam(value="regionName", required = false, defaultValue = "서울") String regionName) throws IOException, JSONException {
		
		final String serviceKey = "oYL/ms89Dv8lorwizkh3qauQxqj4GaOlXxAeuGRDvsI5/3suhK8Z6j0fWZVu0qHWv2dme7YPnJkajmnzBV4NJQ==";
