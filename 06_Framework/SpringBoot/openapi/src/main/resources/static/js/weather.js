...
const regionName = document.getSelection("#regionName");
const currentWeather= document.querySelector(".current-weather");

/* 서비스키 */
const serviceKey = "oYL/ms89Dv8lorwizkh3qauQxqj4GaOlXxAeuGRDvsI5/3suhK8Z6j0fWZVu0qHWv2dme7YPnJkajmnzBV4NJQ==";
...
const getUltraSrtNcst = (regionValue) => {
  ...
  /* Ajax로 regionName 지역의 초단기 예보 요청하기 */
...
region.addEventListener('change' , e => {
    ...
    getUltraSrtNcst(e.target.value); // 해당지역 초단기 예보 조회

});

getUltraSrtNcst("서울"); // 화면 로딩되면 서울날씨 얻어오기