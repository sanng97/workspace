...
/**
 * 페이징 처리에 필요한 모든 값을 꼐산하고 저장하는 객체<br>
 * 현재 페이지, 전체 게시글 수, 한 페이지에 보여질 게시글 수, 보여질 페이지 번호 개수, 보여지는 페이지 번호 중 시작 번호 보여지는
 * 페이지 번호 중 마지막 번호 이전 페이지의 마지막 페이지 번호 다음 페이지의 시작 페이지 번호 마지막 페이지 번호
 */
...
public class Pagination {
	...
	public Pagination(int currentPage, int listCount) {
		...
		calcPagination(); // 객체 생성 시 계산수행해서 모든 필드 초기화
	}
