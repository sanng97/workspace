...
public class FileConfig implements WebMvcConfigurer{
	...
	// 요청 주소가 /images로 시작할 때 와부 폴더로 연결하는 메서드
	// (WebMvcConfigurer 상속 -> addResourceGandlers() 오버라이딩)
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// -> 그냥 위에 구문 따라서 추가
		// (connectPath, resourccePath는 알맞게 작성)
	  ...
	  @Value("${spring.servlet.multipart.file-size-threshold}")
	   ...
	   // MultipartResolver : 텍스트 요청 데이터(문자열, 숫자 등등)는 String으로 변환
