...
public class BoardServiceImpl implements BoardService {
	...
	public Map<String, Object> selectBoardList(int boardCode, int cp) {
		...
		/* cp ,listCount 를 이용해서 Paginaition 객체 생성*/
		...
		/* 마이바티스로 SQL 수행 시
		 * SQL에 전달할 수 있는 파라미터의 개수는 1개 (첫번째 매개변수)
		 * 두번 째 매개변수는 RowBounds 만 가능
		 */
	...
	public int like(Map<String, Object> paramMap) {
	  ...
	  if((Integer)(paramMap.get("check")) == 1 ) {
		  ...
		  // 기존에 좋아요 안한 상태 == check가 0
		  // 좋아요 삽입 == BOARD_LIKE테이블에 INSERT
