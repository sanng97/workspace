...
CREATE USER spring_pse IDENTIFIED BY spring1234;

-- 권한 부여
GRANT CONNECT ,RESOURCE, CREATE VIEW TO spring_pse;

-- 객체 생성 공간 할당
ALTER USER spring_pse DEFAULT TABLESPACE "A230724"
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME ,MEMBER_TEL ,MEMBER_ADDRESS ,MEMBER_DEL_FL PROFILE_IMG ,
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$bzQZLASrix/HbEHY1B3Ny.rZH8G/t8nw6rk9KxflxPwYeo8c3n/Lm'
WHERE MEMBER_NO = 1;
...
INSERT INTO "BOARD_LIKE" VALUES(1499, 1);
...
-- CONNECT BY PRIOR CONNENT_NO = PARENT_NO:
...
SELECT * FROM BOARD_IMG WHERE BOARD_NO = 1514;
...
AND BOARD_CODE = 1
/*제목*/
-- AND BOARD_TITLE LIKE '%12%'

/*내용*/
 AND BOARD_CONTENT LIKE '%12%'
...
-- /images/member/202311091149480003.jpg
...
INSERT INTO "BOARD_TYPE" VALUES (4, '1:1문의');
